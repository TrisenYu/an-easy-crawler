...
# Created at 2025年08月14日 星期四 10时54分44秒
# Last modified at 2025/10/03 星期五 00:07:31
#
# 下列数组摘自 rust 写成的 oxc_unicode
# 用于快速判断给定unicode字符是否是id_start或者id_continue类型
# https://www.unicodesymbol.com/en/applicable-xid-continue-unicodes/meta-123
# https://util.unicode.org/UnicodeJsps/regex.jsp?a=%5B%3AID_Continue%3A%5D&b=
# "identy_char -> UNICODE_ID_CONTINUE",
_T: bool = True
_F: bool = False
ASCII_START: list[bool] = [
	_F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F,
	_F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F,
	_F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F,
	_F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F,
	_F, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T,
	_T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _F, _F, _F, _F, _F,
	_F, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T,
	_T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _F, _F, _F, _F, _F,
]
ASCII_CONTINUE: list[bool] = [
	_F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F,
	_F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F,
	_F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F, _F,
	_T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _F, _F, _F, _F, _F, _F,
	_F, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T,
	_T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _F, _F, _F, _F, _T,
	_F, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T,
	_T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _T, _F, _F, _F, _F, _F
]
...
def _is_xid_start(ch: str) -> bool:
	c = ord(ch) >> 9
	if c < 0 or c >= len(TRIE_START):
		chunk = 0
	else:
		chunk = TRIE_START[c]
	offset = chunk * 32 + (ord(ch) >> 3) % 64
	return (LEAF[offset] >> (ord(ch) & 7)) & 1 != 0

def is_id_start(c: str) -> bool:
	""" 判断是否为 unicode_id_start """
	if c.isascii():
		return ASCII_START[ord(c)]
	return _is_xid_start(c)

def _is_xid_continue(ch: str) -> bool:
	c = ord(ch) >> 9
	if c < 0 or c >= len(TRIE_CONTINUE):
		chunk = 0
	else:
		chunk = TRIE_CONTINUE[c]
	offset = chunk * 32 + (ord(ch) >> 3) % 64
	return (LEAF[offset] >> (ord(ch) & 7)) & 1 != 0

def is_id_continue(c: str) -> bool:
	""" 判断是否为 unicode_id_continue """
	if c.isascii():
		return ASCII_CONTINUE[ord(c)]
	return _is_xid_continue(c)
