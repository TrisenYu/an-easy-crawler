/// https://raw.githubusercontent.com/babel/babel/refs/heads/main/packages/babel-parser/src/parser/statement.ts
...
import {
    ParseBindingListFlags
} from "./lval.ts";
import {
    LoopLabelKind
} from "../tokenizer/state.ts";
...
export default abstract class StatementParser extends ExpressionParser {
    ...
    parseMaybeImportPhase(
        ...
        const isImportPhase = tokenIsKeywordOrIdentifier(type) ? // OK: import <phase> x from "foo";
            ...
            type !== tt._from || this.lookaheadCharCode() === charCodes.lowercaseF : // OK: import <phase> { x } from "foo";
    ...
    isPrecedingIdImportPhase(
        ...
        return tokenIsIdentifier(type) ? // OK: import <phase> x from "foo";
            // OK: import <phase> from from "foo";
            // NO: import <phase> from "foo";
            // NO: import <phase> from 'foo';
            // With the module declarations proposals, we will need further disambiguation
